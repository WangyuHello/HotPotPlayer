...
{
    public sealed partial class VolumeIntPresenter : UserControl
    {
        public VolumeIntPresenter()
        {
        ...
        public static readonly DependencyProperty VolumeProperty =
            DependencyProperty.Register("Volume", typeof(int?), typeof(VolumeIntPresenter), new PropertyMetadata(0));

           
        string GetVolumeText(int? v)
        {
            return v + "%";
        }
