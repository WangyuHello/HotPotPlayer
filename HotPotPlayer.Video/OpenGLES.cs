...
namespace HotPotPlayer.Controls
{
    public class OpenGLES : IDisposable
    {
        ...
        public const Int32 EGL_FALSE = 0;
        public const Int32 EGL_TRUE = 1;
        ...
        private IntPtr mEglDisplay;
        private IntPtr mEglContext;
        private IntPtr mEglConfig;

        public OpenGLES()
        {
            mEglDisplay = EGL_NO_DISPLAY;
            mEglContext = EGL_NO_CONTEXT;
            mEglConfig = default(IntPtr);
        ...
        public void Initialize()
        {
            ...
            {
                throw new Exception("Failed to choose first IntPtr");
            }
        ...
        public IntPtr CreateSurface(SwapChainPanel panel)
        {
            if (panel == null)
            {
            ...
            var surfaceCreationPropertiesNative = surfaceCreationProperties.As<IInspectable>();
            surface = eglCreateWindowSurface(mEglDisplay, mEglConfig, surfaceCreationPropertiesNative.ThisPtr, surfaceAttributes);
        ...
        public Size GetSurfaceDimensions(IntPtr surface)
        {
            int width = 0;
            int height = 0;
        ...
        public void MakeCurrent(IntPtr surface)
        {
            ...
            {
                throw new Exception("Failed to make IntPtr current");
            }
        }

        public void MakeCurrentAlt(IntPtr surfDraw, IntPtr surfRead)
        {
        ...
        public int SwapBuffers(IntPtr surface)
        {
        ...
        private const string libEGL = "NativeLibs/libEGL.dll";
        ...
        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglInitialize(IntPtr dpy, out int major, out int minor);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglChooseConfig(IntPtr dpy, int[] attrib_list, [In, Out] IntPtr[] configs, int config_size, out int num_config);
        ...
        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglQuerySurface(IntPtr dpy, IntPtr surface, int attribute, out int value);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglDestroySurface(IntPtr dpy, IntPtr surface);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglMakeCurrent(IntPtr dpy, IntPtr draw, IntPtr read, IntPtr ctx);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglSwapBuffers(IntPtr dpy, IntPtr surface);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglDestroyContext(IntPtr dpy, IntPtr ctx);

        [DllImport(libEGL, SetLastError = true, CharSet = CharSet.Ansi, BestFitMapping = false)]
        public static extern Int32 eglTerminate(IntPtr dpy);
